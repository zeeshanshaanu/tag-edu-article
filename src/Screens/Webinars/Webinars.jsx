      ...
      {initialLoading ? (
        ...
        <>
          ...
          <div className="lg:flex justify-between mt-3">
            ...
            hover:bg-[#F9F9F9] transition-colors duration-200 ${Status === "upcoming" ? "bg_white font-[700]" : "bg_lightgray2"
                  }`}
              ...
              >
                ...
                <span
                  className={` my-auto text-[14px] my-auto ${Status === "upcoming" ? "black" : "gray"
                    }`}
                >
                  Upcoming
                </span>
          ...
          `}
              ...
              >
                ...
                <span
                  className={`text-[14px] my-auto ${Status === "past" ? "black" : "gray"
                    }`}
                >
                  Past
                </span>
                            ...
                            <>
                              {!items?.enrolled && items?.is_live ? (
                                ...
                                <button
                                  ...
                                  className={`flex justify-center gap-1 w-full text-center py-2 px-5 rounded-[8px] text-[14px] font-[700] ${enrollmentLoadingIds.has(items._id)
